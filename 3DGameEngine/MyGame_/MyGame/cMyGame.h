...
#include <Engine/Networking/GameClient.h>
...
namespace eae6320
{
	...
	private:
		...
		{
			return "Revanth Ponna's EAE6320 Game"
				" -- "
		...
		const char* GetMainWindowClassName() const final { return "Revanth Ponna's EAE6320 Example Main Window Class"; }
	...
	// Data members
		...
		// Mesh Effect Data
		//-----------------
		static constexpr uint16_t numMeshEffectPairs = 1;
		static constexpr float playerVelocity = 0.1f;
