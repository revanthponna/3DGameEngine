...
{
	return eae6320::Math::cMatrix_transformation::CreateCameraToProjectedTransform_perspective(Math::ConvertHorizontalFieldOfViewToVerticalFieldOfView(eae6320::Math::ConvertDegreesToRadians(45), 1.0f), 1.0f, 0.1f, 10.0f);
}